...
Classificeert URLs per type (github_repo, internet_nl, forum, ncsc).
...
URL_PATTERNS = {
    "github_repo": re.compile(r"https://github\.com/internetstandards/[A-Za-z0-9._-]+"),
    "internet_nl": re.compile(r"https://(?:www\.)?internet\.nl/[^\s\)\]\"'>]+"),
    "forum": re.compile(r"https://www\.forumstandaardisatie\.nl/[^\s\)\]\"'>]+"),
    "ncsc": re.compile(r"https://(?:www\.)?ncsc\.nl/[^\s\)\]\"'>]+"),
}
...
_GITHUB_REPO_BASE_RE = re.compile(
    r"(https://github\.com/internetstandards/[A-Za-z0-9._-]+)"
